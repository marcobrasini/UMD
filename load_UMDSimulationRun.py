...
class Load_OUTCAR:
    ...
    def print_parameters():
        print('initialStep:', Load_OUTCAR.initialStep)
        print('finalStep:  ', Load_OUTCAR.finalStep)
        print('loadedSteps:', Load_OUTCAR.loadedSteps)
        print('nSteps:     ', Load_OUTCAR.nSteps)
